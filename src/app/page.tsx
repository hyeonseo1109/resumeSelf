...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f5f0] text-zinc-950 ">
      <TopNav />
      <main className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_720px] lg:py-16">
        <section className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Link
              href="/dashboard"
              className="inline-flex h-11 items-center gap-2 rounded-md bg-zinc-950 px-5 text-sm font-semibold text-white hover:bg-zinc-800"
            >
              Dashboard 시작
          ...
          <div className="grid gap-3 rounded-md bg-zinc-950 p-4 text-white">
            ...
            <div className="grid grid-cols-[120px_1fr_140px] gap-3">
              <Panel
                ...
                title="Insert"
                text="Text, Image, Video, Section"
              />
              <div className="min-h-90 rounded-md bg-white p-5 text-zinc-950">
