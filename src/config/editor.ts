...
export const iconOptions: IconOption[] = [
  ...
  { id: "circle", label: "Circle", src: "/icons/icon_circle.png" },
  { id: "star", label: "Star", src: "/icons/icon_star.png" },
  { id: "heart", label: "Heart", src: "/icons/icon_heart.png" },
];
